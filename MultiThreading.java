...
import java.util.*;
public class MultiThreading implements Runnable//thread creation by implementing the Runnable Interface 
{
	Thread t;
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("Fifth Thread is Alive? : " +ob5.t.isAlive());
